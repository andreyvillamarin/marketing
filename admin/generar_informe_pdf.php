...
try {
    ...
    $stmt_completadas = $pdo->prepare("SELECT nombre_tarea, fecha_vencimiento FROM tareas t JOIN tareas_asignadas ta ON t.id_tarea = ta.id_tarea WHERE ta.id_usuario = ? AND t.estado = 'cerrada' AND t.fecha_vencimiento BETWEEN ? AND ? ORDER BY fecha_vencimiento DESC");
